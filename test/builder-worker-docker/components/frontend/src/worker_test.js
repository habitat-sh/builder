...
const request = supertest("http://builder-core:9636/v1");
const fs = require("fs");
...
describe("Startup/Origin Creation", function () {
  beforeEach('SLEEP 299', async function() {
    console.log("Pause 299");
    await new Promise(resolve => setTimeout(resolve, 290000));
  });
  ...
  describe("Scheduling jobs", function () {
    ...
    it("Schedules job and returns group", function (done) {
      request
        ...
        .accept("application/json")
        .set("Authorization", global.boboBearer)
        .set("Referer", "http://builder-core:9636")
        .expect(201)
        .end(function (err, res) {
...
describe("Jobsrv and Worker - Dispatched", function() {
    beforeEach('SLEEP 5s', async function() {
      console.log("Pause 5s");
      await new Promise(resolve => setTimeout(resolve, 5000));
    });
...
describe("Jobsrv and Worker - Complete", function() {
    beforeEach('SLEEP 45s', async function() {
      console.log("Pause 45s");
