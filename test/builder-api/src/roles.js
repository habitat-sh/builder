...
const file1 = fs.readFileSync(
  __dirname + `/../fixtures/rcpd-testapp-0.1.0-${release1}-x86_64-linux.hart`
);
const revision = "20200401201905";
const pubFile = fs.readFileSync(
  __dirname + `/../fixtures/rcpd-${revision}.pub`,
  "utf8"
);
const secretFile = fs.readFileSync(
  __dirname + `/../fixtures/rcpd-${revision}.sig.key`,
  "utf8"
);
...
describe("Origin Roles API", function () {
  ...
  describe("Uploads an origin signing key", function () {
    it("uploads the key", function (done) {
      request
        .post(`/depot/origins/rcpd/secret_keys/${revision}`)
        .set("Authorization", global.boboBearer)
        .send(secretFile)
        .expect(201)
        .end(function (err, res) {
  ...
  describe("Upload a fixture package", function () {
    it("allows authenticated users to upload packages", function (done) {
      request
        .post(`/depot/pkgs/rcpd/testapp/0.1.0/${release1}`)
        .set("Authorization", global.boboBearer)
        .set("Content-Length", file1.length)
        .query({
          checksum:
            "569bf7fa781bcf5fb167d42884728ffdb264cf9ad6ac05b2a217406070a4c7ba",
        })
        .send(file1)
        .expect(201)
        .end(function (err, res) {
          expect(res.text).to.equal(
            `/pkgs/rcpd/testapp/0.1.0/${release1}/download`
          );
          done(err);
        });
    });
  ...
  describe("Invite lkennedy", function () {
    it("lkennedy gets invited", function (done) {
      request
        .post("/depot/origins/rcpd/users/lkennedy/invitations")
        .set("Authorization", global.boboBearer)
        .expect(201)
        .end(function (err, res) {
  ...
  describe("lkennedy accepts the invite", function () {
    it("lkennedy joins the origin", function (done) {
      request
        .put(
          "/depot/origins/rcpd/invitations/" + global.inviteLkennedyToRcpd.id
        )
  ...
  describe("Query a member role", function () {
    it("returns the default member role for lkennedy", function (done) {
      request
        ...
        .expect(200)
        .end(function (err, res) {
          expect(res.body.role).to.equal("readonly_member");
          done(err);
        });
    });
  });
  describe("Origin readonly_member behaviors", function () {
    it("user with readonly_member role not authorized to send invitation", function (done) {
      request
        .post("/depot/origins/rcpd/users/wesker/invitations")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
        .end(function (err, res) {
    ...
    it("user with readonly_member role not authorized to elevate own role", function (done) {
      request
        .put("/depot/origins/rcpd/users/lkennedy/role")
    ...
    it("user with readonly_member role not authorized to alter other user role", function (done) {
      request
        .put("/depot/origins/rcpd/users/bobo/role")
        .query({ role: "member" })
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
        .end(function (err, res) {
    ...
    it("user with readonly_member role not authorized to upload packages", function (done) {
      request
        .post(`/depot/pkgs/rcpd/testapp/0.1.0/${release1}`)
        .set("Authorization", global.lkennedyBearer)
        .set("Content-Length", file1.length)
    ...
    it("user with readonly_member role not authorized to delete a package", function (done) {
      request
        .delete(`/depot/pkgs/rcpd/testapp/0.1.0/${release1}`)
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
        .end(function (err, res) {
          expect(res.text).to.be.empty;
    ...
    it("user with readonly_member role not authorized to create origin keys", function (done) {
      request
        .post("/depot/origins/rcpd/keys")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
        .end(function (err, res) {
          expect(res.text).to.be.empty;
    ...
    it("user with readonly_member role not authorized to get origin signing key", function (done) {
      request
        .post("/depot/origins/rcpd/secret_keys/latest")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
        .end(function (err, res) {
          expect(res.text).to.be.empty;
    ...
    it("user with readonly_member role not authorized to upload origin public key", function (done) {
      request
        .post("/depot/origins/rcpd/keys/${revision}")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
        .end(function (err, res) {
          expect(res.text).to.be.empty;
    ...
    it("user with readonly_member role not authorized to upload origin secret key", function (done) {
      request
        .post("/depot/origins/rcpd/secret_keys/${revision}")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
    ...
    it("user with readonly_member role not authorized to list origin secrets", function (done) {
      request
        .get("/depot/origins/rcpd/secret")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
        .end(function (err, res) {
    ...
    it("user with readonly_member role not authorized to delete origin secrets", function (done) {
      request
        .delete("/depot/origins/rcpd/secret/foo")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
        .end(function (err, res) {
          expect(res.text).to.be.empty;
    ...
    it("user with readonly_member role not authorized to demote a package", function (done) {
      request
        .put(
          `/depot/channels/rcpd/unstable/pkgs/testapp/0.1.0/${release1}/demote`
        )
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
        .end(function (err, res) {
    ...
    it("user with readonly_member role not authorized to promote a package", function (done) {
      request
        .put(
          `/depot/channels/rcpd/stable/pkgs/testapp/0.1.0/${release1}/promote`
        )
        .set("Authorization", global.lkennedyBearer)
        .expect(401)
        .end(function (err, res) {
    ...
    it("user with readonly_member role not authorized to update the origin settings", function (done) {
      request
        .put("/depot/origins/rcpd")
        .set("Authorization", global.lkennedyBearer)
  ...
  describe("Promote lkennedy to maintainer role", function () {
    ...
    it("shows updated maintainer role", function (done) {
      request
        .get("/depot/origins/rcpd/users/lkennedy/role")
        .type("application/json")
        .accept("application/json")
  ...
  describe("Origin Maintainer Permissions Behaviors", function () {
    it("user with maintainer role not authorized to elevate own role", function (done) {
      request
        .put("/depot/origins/rcpd/users/lkennedy/role")
        .query({ role: "maintainer" })
        .set("Authorization", global.lkennedyBearer)
    ...
    it("user with maintainer role not authorized to alter other user role", function (done) {
      request
        .put("/depot/origins/rcpd/users/bobo/role")
        .query({ role: "member" })
        .set("Authorization", global.lkennedyBearer)
    ...
    it("user with maintainer role not authorized to demote a package", function (done) {
      request
        .put(
          `/depot/channels/rcpd/unstable/pkgs/testapp/0.1.0/${release1}/demote`
        )
    ...
    it("user with maintainer role not authorized to create origin keys", function (done) {
      request
        .post("/depot/origins/rcpd/keys")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
    ...
    it("user with maintainer role not authorized to get origin signing key", function (done) {
      request
        .post("/depot/origins/rcpd/secret_keys/latest")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
    ...
    it("user with maintainer role not authorized to upload origin public key", function (done) {
      request
        .post("/depot/origins/rcpd/keys/${revision}")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
    ...
    it("user with maintainer role not authorized to upload origin secret key", function (done) {
      request
        .post("/depot/origins/rcpd/secret_keys/${revision}")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
    ...
    it("user with maintainer role not authorized to list origin secrets", function (done) {
      request
        .get("/depot/origins/rcpd/secret")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
    ...
    it("user with maintainer role not authorized to delete origin secrets", function (done) {
      request
        .delete("/depot/origins/rcpd/secret/foo")
        .set("Authorization", global.lkennedyBearer)
        .expect(403)
  ...
  describe("Promote lkennedy to administrator role", function () {
    it("changes the user role", function (done) {
      request
        .put("/depot/origins/rcpd/users/lkennedy/role")
    ...
    it("shows updated administrator role", function (done) {
      request
        .get("/depot/origins/rcpd/users/lkennedy/role")
        .type("application/json")
        .accept("application/json")
  ...
  describe("Origin Administrator Permissions Behaviors", function () {
    it("user with administrator role not authorized to elevate own role to owner", function (done) {
      request
        .put("/depot/origins/rcpd/users/lkennedy/role")
        .query({ role: "owner" })
        .set("Authorization", global.lkennedyBearer)
    ...
    it("user with administrator role not authorized to alter role of current owner", function (done) {
      request
        .put("/depot/origins/rcpd/users/bobo/role")
        .query({ role: "member" })
        .set("Authorization", global.lkennedyBearer)
    ...
    it("user with administrator role authorized to promote a package", function (done) {
      request
        .put(
          `/depot/channels/rcpd/stable/pkgs/testapp/0.1.0/${release1}/promote`
        )
    ...
    it("user with administrator role authorized to demote a package", function (done) {
      request
        .put(
          `/depot/channels/rcpd/stable/pkgs/testapp/0.1.0/${release1}/demote`
        )
        .set("Authorization", global.lkennedyBearer)
        .expect(200)
        .end(function (err, res) {
    ...
    it("user with administrator role authorized to create origin keys", function (done) {
      request
        .post("/depot/origins/rcpd/keys")
        .set("Authorization", global.lkennedyBearer)
        .expect(201)
    ...
    it("user with administrator role authorized to get origin signing key", function (done) {
      request
        .get("/depot/origins/rcpd/secret_keys/latest")
        .set("Authorization", global.lkennedyBearer)
        .expect(200)
        .end(function (err, res) {
    ...
    it("user with administrator role authorized to upload origin public key", function (done) {
      request
        .post("/depot/origins/rcpd/keys/${revision}")
        .set("Authorization", global.lkennedyBearer)
        .expect(422)
    ...
    it("user with administrator role authorized to upload origin secret key", function (done) {
      request
        .post("/depot/origins/rcpd/secret_keys/${revision}")
        .set("Authorization", global.lkennedyBearer)
        .expect(422)
    ...
    it("user with administrator role authorized to list origin secrets", function (done) {
      request
        .get("/depot/origins/rcpd/secret")
        .set("Authorization", global.lkennedyBearer)
        .expect(200)
    ...
    it("user with administrator role authorized to delete origin secrets", function (done) {
      request
        .delete("/depot/origins/rcpd/secret/foo")
        .set("Authorization", global.lkennedyBearer)
        .expect(200)
  ...
  describe("Origin Member Permissions Behaviors", function () {
    ...
    it("user with member role authorized to delete a package", function (done) {
      request
        .delete(`/depot/pkgs/rcpd/testapp/0.1.0/${release1}`)
        .set("Authorization", global.lkennedyBearer)
        .expect(204)
    ...
    it("user with member role authorized to upload packages", function (done) {
      request
        .post(`/depot/pkgs/rcpd/testapp/0.1.0/${release1}`)
        .set("Authorization", global.lkennedyBearer)
        .set("Content-Length", file1.length)
    ...
    it("user with member role authorized to get origin signing key", function (done) {
      request
        .get("/depot/origins/rcpd/secret_keys/latest")
        .set("Authorization", global.lkennedyBearer)
        .expect(200)
    ...
    it("user with member role not authorized to update the origin settings", function (done) {
      request
        .put("/depot/origins/rcpd")
        .set("Authorization", global.lkennedyBearer)
        .send({ default_package_visibility: "public" })
  ...
  describe("Package visibility and non origin member searches", function () {
    it("non origin member cannot see latest release of a package when its private", function (done) {
      request
        .get("/depot/pkgs/rcpd/testapp/latest")
    ...
    it("force re-upload the package to make its visibility public", function (done) {
      request
        .post(`/depot/pkgs/rcpd/testapp/0.1.0/${release1}?forced=true`)
        .set("Authorization", global.boboBearer)
        .set("Content-Length", file1.length)
        .query({
          checksum:
    ...
    it("Role change request for non origin member returns 404", function (done) {
      request
        .put("/depot/origins/umbrella/users/lkennedy/role")
        .query({ role: "member" })
        .set("Authorization", global.boboBearer)
        .expect(404)
        .end(function (err, res) {
