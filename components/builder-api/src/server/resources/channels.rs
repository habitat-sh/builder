...
use crate::db::models::{
    channel::*,
    origin::*,
    package::{BuilderPackageIdent, GetPackageGroup, Package, PackageVisibility},
};
...
use crate::server::{
    ...
    error::{Error, Result},
    framework::headers,
    helpers::{self, req_state, visibility_for_optional_session, Pagination, Target, ToChannel},
...
#[allow(clippy::needless_pass_by_value)]
async fn promote_channel_packages(
    req: HttpRequest,
    path: Path<(String, String)>,
    state: Data<AppState>,
    ...
    match do_promote_or_demote_channel_packages(
        &req,
        &ch_source,
        &ch_target,
        &origin,
...
#[allow(clippy::needless_pass_by_value)]
async fn demote_channel_packages(
    req: HttpRequest,
    path: Path<(String, String)>,
    state: Data<AppState>,
    to_channel: Query<ToChannel>,
...
fn do_promote_or_demote_channel_packages(
    req: &HttpRequest,
...
async fn promote_package(
    ...
    let auditevent = PackageChannelAudit {
...
async fn demote_package(
    ...
    .map_err(Error::DieselError)
    {
        Ok(0) => {
            debug!(
                "Requested package {} for target {} not present in channel {}",
...
#[allow(clippy::needless_pass_by_value)]
async fn get_packages_for_origin_channel_package_version(
    req: HttpRequest,
...
#[allow(clippy::needless_pass_by_value)]
async fn get_packages_for_origin_channel_package(
    req: HttpRequest,
...
#[allow(clippy::needless_pass_by_value)]
async fn get_packages_for_origin_channel(
    req: HttpRequest,
    path: Path<(String, String)>,
    pagination: Query<Pagination>,
) -> HttpResponse {
...
#[allow(clippy::needless_pass_by_value)]
async fn get_latest_package_for_origin_channel_package(
    req: HttpRequest,
    path: Path<(String, String, String)>,
    qtarget: Query<Target>,
) -> HttpResponse {
...
#[allow(clippy::needless_pass_by_value)]
async fn get_latest_package_for_origin_channel_package_version(
    req: HttpRequest,
    path: Path<(String, String, String, String)>,
    qtarget: Query<Target>,
) -> HttpResponse {
...
#[allow(clippy::needless_pass_by_value)]
async fn get_package_fully_qualified(
    req: HttpRequest,
    path: Path<(String, String, String, String, String)>,
    qtarget: Query<Target>,
) -> HttpResponse {
...
#[allow(clippy::needless_pass_by_value)]
async fn get_latest_packages_for_origin_channel(
    req: HttpRequest,
    path: Path<(String, String)>,
    qtarget: Query<Target>,
) -> HttpResponse {
...
fn do_get_latest_channel_packages(
    req: &HttpRequest,
    qtarget: &Query<Target>,
    origin: &str,
...
fn do_get_all_channel_packages(
    req: &HttpRequest,
    origin: &str,
    channel: &ChannelIdent,
    ...
    Channel::list_all_packages(
        &ListAllChannelPackages {
            visibility: &PackageVisibility::all(),
            origin,
            channel,
        },
