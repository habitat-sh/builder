...
use crate::{
    error::{Error, Result},
    hab_core::{
        package::{self, Identifiable, PackageTarget},
        ChannelIdent,
    },
    http_client::{ACCEPT_APPLICATION_JSON, USER_AGENT_BLDR},
};
...
impl ApiClient {
    pub fn new(url: &str) -> Result<Self> {
        ...
        Ok(ApiClient {
            inner: HttpClient::new(url, headers)?,
            url: url.to_owned(),
        })
    }
    ...
    pub async fn promote_package<I>(
        &self,
