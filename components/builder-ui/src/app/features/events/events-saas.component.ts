// filepath: /Users/psajja/Workspace/habitat-sh/builder/components/builder-ui/src/app/features/events/events-saas.component.ts
...
import { EventsSearchParams } from './models/event.model';

@Component({
  selector: 'app-events-saas',
  standalone: true,
  imports: [
    CommonModule,
    RouterLink,
        ...
        <div class="content">
          ...
          <section class="events-filter">
            <input
              ...
              placeholder="Search SaaS Events&hellip;">
            ...
            <div class="results-container">
              ...
              <ng-container *ngIf="!loading">
                <div class="no-results" *ngIf="events.length === 0">
                  No SaaS events found. Try adjusting your search criteria.
                </div>
...
export class EventsSaasComponent extends BaseEventsComponent {
  ...
  protected override loadEvents(): void {
    ...
    this.subscriptions.add(
      this.eventsService.getSaasEvents(params)
