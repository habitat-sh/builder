...
impl DataStore {
    ...
    pub fn get_origin_channel_latest(&self,
        ...
        // I want something like this query but haven't gotten it to work in diesel
        //
        // SELECT distinct on(op.name)
        //     op.ident
        ...
        //    ORDER BY
        //      op.name,
        //      regexp_matches(op.ident_array[3], '([\d\.]*\d+)(.+)?'::text) desc,
        //      op.ident_array[4] desc;
