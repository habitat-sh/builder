...
impl DataStore {
    ...
    pub fn get_origin_channel_latest(&self,
        ...
        let query =
            origin_packages_with_version_array::table.inner_join(origin_channel_packages::table.inner_join(origin_channels::table))
                                  .select(origin_packages_with_version_array::ident)
                                  .distinct_on((origin_packages_with_version_array::name, origin_packages_with_version_array::target))
